    ...
    return (
        <div>
            <dialog id="my_modal_1" className="modal">
                <div className="modal-box bg-white w-[300px] -mt-36">
                <div>
                    <div className='flex justify-center mb-2'>
                    <img className='w-full h-32' src={serviceData.image_url} alt='service photo'/>
                    </div>
                    <h2 className='text-md font-bold'>{serviceData.name}</h2>
                    <h2 className='text-md font-semibold my-3'>24/7 On-Demand Car Battery Replacement & Repair – Anywhere, Just Call or WhatsApp with Your Location</h2>
                </div>
                    ...
                    <div className="modal-action -mb-2">
                        <form method="dialog">
                            <button className=" py-1 px-5 rounded bg-red-500 text-white border-0">Close</button>
                        </form>
                    </div>
                </div>
            </dialog>
