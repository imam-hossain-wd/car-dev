    ...
    <div id="product">
      <div>
        <div className="text-center my-8 flex flex-col justify-center items-center ">
          <h3 className=" text-xl font-bold px-3 bg-gray-300 p-2 mb-2 ">
            Upgrade Your Ride with Our Products
          </h3>
        </div>
              ...
              >
                ...
                <div className="flex justify-center mt-5">
                  <Link href={`/products/${product.title}`}>
                    <button className="text-md font-bold bg-neavyBlue hover:bg-neavyBlueHover duration-500 py-2 px-5 text-white w-36  rounded">
                      Details
                    </button>
                  </Link>
                </div>
      ...
      <div className="flex justify-center items-center">
        <Link
          href="/products"
          className="bg-neavyBlue text-white px-5 py-2 font-semibold hover:bg-neavyBlueHover m-5 rounded"
        >
          All Products
        </Link>
      </div>
